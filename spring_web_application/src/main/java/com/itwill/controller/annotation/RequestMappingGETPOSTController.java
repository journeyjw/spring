...
public class RequestMappingGETPOSTController {
	...
	public String get_login_form() {
		return "forward:/WEB_INF/views/get_login_form.jsp";
	}
	@RequestMapping(value="/login.do",method = RequestMethod.POST)
	public String post_login_action(@RequestParam String id,@RequestParam String password,HttpSession session) {
