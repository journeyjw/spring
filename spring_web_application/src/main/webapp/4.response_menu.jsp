...
<body>
	...
	<a href='./'>메인메뉴</a>
	<ol>
		<li><a href='response_forward_view_name.do'>Controller가 view name(String) 을반환 [forward]</a></li>
		<li><a href='response_forward_view_object.do'>Controller가 view 객체[InternalResourceView]를반환 [forward]</a></li>
		<li><a href='response_redirect_view_name.do'>Controller가 view name(String)을반환 [redirect]</a></li>
		...
		<li><a href='response_xml_view_name.do'>Controller가 view name(String) [xmlView]을반환 [출력]</a></li>
		...
		<li><a href='response_xml.do'>Controller가 응답 Dto객체를xml로반환[@ResponseBody]</a></li>
		<li><a href='response_json.do'>Controller가 응답 Dto객체를json로반환[@ResponseBody]</a></li>
		<!-- 
